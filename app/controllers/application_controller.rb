class ApplicationController < ActionController::Base
  ...
  protected
    ...
    def configure_permitted_parameters
      ...
      devise_parameter_sanitizer.permit(:sign_up) { |u| u.permit(:name,:username,:college,:description,:collegiate_id,:email,:password,:password_confirmation,:curriculum_path, :birthday) }
      devise_parameter_sanitizer.permit(:account_update) { |u| u.permit(:name,:username,:college,:description,:collegiate_id,:email,:password, :password_confirmation,:current_password, :curriculum_path,:birthday, :notes) }
    end
